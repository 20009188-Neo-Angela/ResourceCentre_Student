...
public class ResourceCentreTest {
	...
	public void testRetrieveAllChromebook() {
		...
		// test if the list of chromebooks retrieved from the ResourceCentre is empty
	...
	public void testDoReturnCamcorder() {
		...
		assertFalse("Test if available camcorder CC0011 is returned - false?", isFound);
		
		//normal condition
		ResourceCentre.addCamcorder(camcorderList, cc2);
		cc2.setIsAvailable(false);
		isFound = ResourceCentre.doReturnCamcorder(camcorderList, "CC0012");
		assertTrue("Test if loaned out camcorder CC0012 is returned - true?" , isFound);
		
		//error condition
		isFound = ResourceCentre.doReturnCamcorder(camcorderList, "CC0013");
		assertFalse("Test if non-existing camcorder CC0013 is returned - false?", isFound);
	...
	public void testDoReturnChromebook() {
		// fail("Not yet implemented");
				...
				assertFalse("Test if available chromebook CB0011 is returned - false?", isFound);
				
				//normal condition
				ResourceCentre.addChromebook(chromebookList, cb2);
				cb2.setIsAvailable(false);
				isFound = ResourceCentre.doReturnChromebook(chromebookList, "CB0012");
				assertTrue("Test if loaned out chromebook CB0012 is returned - true?" , isFound);
				
				//error condition
				isFound = ResourceCentre.doReturnChromebook(chromebookList, "CB0013");
				assertFalse("Test if non-existing chromebook CB0013 is returned - false?", isFound);
