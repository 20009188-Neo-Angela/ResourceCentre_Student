...
public class ResourceCentre {
	...
	public static String retrieveAllCamcorder(ArrayList<Camcorder> camcorderList) {
		...
		for (int i = 0; i < camcorderList.size(); i++) {
			...
			output += String.format("%-12s %-22s %-15s %-15s %-7d\n", camcorderList.get(i).getAssetTag(),
	...
	public static void viewAllCamcorder(ArrayList<Camcorder> camcorderList) {
		...
		String output = String.format("%-12s %-22s %-15s %-15s %-7s\n", "ASSET TAG", "DESCRIPTION",
	...
	public static String retrieveAllChromebook(ArrayList<Chromebook> chromebookList) {
		String output = "";
		// write your code here - Angela
		
		for (int i = 0; i < chromebookList.size(); i++) {

			output += String.format("%-12s %-22s %-15s %-15s %-7s\n", chromebookList.get(i).getAssetTag(),
	...
	public static Chromebook inputChromebook() {	
		...
		Chromebook cb= new Chromebook(tag, description, zoom);
		return cb;
